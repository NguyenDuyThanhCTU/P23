  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex w-full justify-center">
        <div
          className="py-2  px-10 duration-300 cursor-pointer text-white bg-mainGreen border-mainGreen uppercase border rounded-full font-normal hover:bg-orange-500 hover:border-orange-500"
